  ...
  return (
    <div>
      ...
      <div style="background-color: white;height: 100vh;width: 100%;display: flex;justify-content: center;align-items: center;">
        ...
        <button onclick="location.reload();" style="cursor:pointer; font-size: 18px;line-height: 28px;color: #fff;background: #0064d2;border-radius: 24px;padding-top: 9px;padding-bottom: 11px;width: 100%;border: none;">RETRY</button>
        </div>
    </div>
    </div>
  )
