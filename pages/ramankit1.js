  ...
  return (
    <div>
      ...
      <div className='container p-8 bg-slate-100'>
        ...
        <a href='https://webviews-psi.vercel.app/ramankit2' className="shadow-md rounded-md p-2 w-full bg-neutral-50 active:bg-sky-300 text-center">
              Ramankit 2 for case 3
          </a>
        </div>
      </div>
    </div>
